...
<body>
	...
	<form id="form1">
		...
		<div class="form-group" id="options">
			<label for="title"> 投票项目： <button class="btn btn-outline-info" type="button" onclick="addOptions()">增加项目</button> </label>
			 <input  type="text" name="options" class="form-control" >
		</div>
		<div class="form-group">
		 <button class="btn btn-outline-warning" type="button" onclick="publishVote()">发起投票</button>
		</div>
	</form>
